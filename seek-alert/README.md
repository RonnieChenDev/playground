...
`sudo apt install -y nodejs chromium-browser fonts-liberation libatk-bridge2.0-0 libatk1.0-0 libcups2 libdrm2 libgbm1 libnss3 libxcomposite1 libxdamage1 libxrandr2 xdg-utils`

3. Clone the project code to VM
...
pm2 start "npx tsx src/index.ts" --name seek-alert --cwd ~/seek-alert
pm2 save
pm2 startup
```